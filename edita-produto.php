                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo $titulo; ?> :: <?php echo $produto["id"]." |" .$produto["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
...
<div class="mb-3">
                                        <label for="decricao" class="form-label">Descricao</label>
                                        <textarea 
                                         id="descricao" 
                                         name="descricao" 
                                          class="form-control" 
                                        ...
                                        <div class="invalid-feedback">
                                            Por favor, insira a descricao.
                                        </div>
                                        </div>
<?php
//Inicializa todas as opções vazias
$tamanhos = ['PP' => '', 'P'=> '', 'M'=> '', 'G' => '', 'GG' => '', 'X' => ''];
...
?>
                                       ...
                                       <select id="tamanho" name="tamanho" 
                                            ...
                                            <option value="PP" <?php echo $tamanhos['PP']; ?>>PP</option>
                                             ...
                                             <option value="X" <?php echo $tamanhos['X']; ?>>X</option>
                                             </select>
                                        <div class="invalid-feedback">
