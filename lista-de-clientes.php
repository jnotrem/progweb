...
// Busca a lista de produtos
   ...
   // var_dump($listaClientes);
    $qtd_prod = count($listaClientes);

                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            <td>".$listaClientes[$i]["id"]."</td>
                                            <td>".$listaClientes[$i]["nome"]."</td>
                                            <td><span class=\"badge text-bg-primary\">".$listaClientes[$i]["email"]."</span></td>
                                            <td>".$listaClientes[$i]["telefone"]."</td>
                                            
<td class=\"text-center\">
    <a href=\"edita-cliente.php?id=".$listaClientes[$i]["id"]."\" class=\"btn btn-primary btn-sm\" title=\"Editar\"><i class=\"bi bi-pencil\"></i></a>
    <a href=\"exclui-cliente.php?id=".$listaClientes[$i]["id"]."\" class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza de que deseja excluir este usuario?');\"><i class=\"bi bi-trash\"></i></a>
</td>
</tr>
                                        ";
                        }
