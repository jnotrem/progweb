...
// Busca a lista de produtos
   ...
   // var_dump($listaUsuario);
    $qtd_prod = count($listaUsuario);

                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            <td>".$listaUsuario[$i]["id"]."</td>
                                            <td>".$listaUsuario[$i]["nome"]."</td>
                                            <td><span class=\"badge text-bg-primary\">".$listaUsuario[$i]["email"]."</span></td>
<td class=\"text-center\">
    <a href=\"edita-usuario.php?id=".$listaUsuario[$i]["id"]." class=\"btn btn-primary btn-sm\" title=\"Editar\"><i class=\"bi bi-pencil\"></i></a>
    <a href=\"exclui-usuario.php?id=".$listaUsuario[$i]["id"]." class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza de que deseja excluir este usuario?');\"><i class=\"bi bi-trash\"></i></a>
</td>
</tr> 
                                        ";
                        }
