...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $msg = "Erro ao atualizar o clientes.";
}
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo $titulo; ?> :: <?php echo $clientes["id"]." |" .$clientes["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-cliente.php?id=<?php echo $clientes['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        <label for="endereco" class="form-label">endereco do cliente</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="data_nascimento" class="form-label">data de nascimento do cliente</label>
