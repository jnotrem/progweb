...
<td class=\"text-center\">
    <a href=\"edita-produto.php?id=".$listaProdutos[$i]["id"]." class=\"btn btn-primary btn-sm\" title=\"Editar\"><i class=\"bi bi-pencil\"></i></a>
    <a href=\"exclui-produto.php?id=".$listaProdutos[$i]["id"]." class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza de que deseja excluir este produto?');\"><i class=\"bi bi-trash\"></i></a>
</td>
</tr>
                                        ";
                        }
