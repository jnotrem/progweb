                    ...
                    <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 1-->
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                            <div class="small-box text-bg-success">
                                ...
                                </svg> <a href="lista-de-clientes.php" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 3-->
                            <div class="small-box text-bg-warning">
                                ...
                                </svg> <a href="lista-de-usuarios.php" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
                                    Mais info <i class="bi bi-link-45deg"></i> </a>
